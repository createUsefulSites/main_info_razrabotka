...
`,s=document.querySelector("#app"),u=c.split(/\d+\) /).slice(1);var p={Ё:"YO",Й:"I",Ц:"TS",У:"U",К:"K",Е:"E",Н:"N",Г:"G",Ш:"SH",Щ:"SCH",З:"Z",Х:"H",Ъ:"'",ё:"yo",й:"i",ц:"ts",у:"u",к:"k",е:"e",н:"n",г:"g",ш:"sh",щ:"sch",з:"z",х:"h",ъ:"'",Ф:"F",Ы:"I",В:"V",А:"A",П:"P",Р:"R",О:"O",Л:"L",Д:"D",Ж:"ZH",Э:"E",ф:"f",ы:"i",в:"v",а:"a",п:"p",р:"r",о:"o",л:"l",д:"d",ж:"zh",э:"e",Я:"Ya",Ч:"CH",С:"S",М:"M",И:"I",Т:"T",Ь:"'",Б:"B",Ю:"YU",я:"ya",ч:"ch",с:"s",м:"m",и:"i",т:"t",ь:"'",б:"b",ю:"yu"};function l(n){return n.split("").map(function(t){return p[t]||t}).join("")}for(let n of u){const[t,r]=n.replace(`
`,"DELETE").split("DELETE"),o=document.createElement("h1");o.innerHTML=t+" ("+l(t.toUpperCase()).slice(0,12)+"...)",o.id=l(t.toUpperCase());const e=document.createElement("span");e.innerHTML=r,s.appendChild(o),s.appendChild(e)}const m=document.querySelector("#input"),d=document.querySelectorAll("h1");function C(n){const t=n.target.value.toLowerCase();console.log(t),d.forEach(r=>{r.id.toLowerCase().includes(t)&&r.scrollIntoView()})}m.addEventListener("input",C);
