...
`,a=document.querySelector("#app"),E=c.split(/\d+\. /).slice(1);var D={Ё:"YO",Й:"I",Ц:"TS",У:"U",К:"K",Е:"E",Н:"N",Г:"G",Ш:"SH",Щ:"SCH",З:"Z",Х:"H",Ъ:"'",ё:"yo",й:"i",ц:"ts",у:"u",к:"k",е:"e",н:"n",г:"g",ш:"sh",щ:"sch",з:"z",х:"h",ъ:"'",Ф:"F",Ы:"I",В:"V",А:"A",П:"P",Р:"R",О:"O",Л:"L",Д:"D",Ж:"ZH",Э:"E",ф:"f",ы:"i",в:"v",а:"a",п:"p",р:"r",о:"o",л:"l",д:"d",ж:"zh",э:"e",Я:"Ya",Ч:"CH",С:"S",М:"M",И:"I",Т:"T",Ь:"'",Б:"B",Ю:"YU",я:"ya",ч:"ch",с:"s",м:"m",и:"i",т:"t",ь:"'",б:"b",ю:"yu"};function l(r){return r.split("").map(function(t){return D[t]||t}).join("")}String.prototype.removeAllExceptWords=function(){return this.replace(/\W+/g,"").toLowerCase()};for(let r of E){const[t,o]=r.replace(`
`,"DELETE").split("DELETE"),i=document.createElement("h1");i.innerHTML=t+" ("+l(t.toUpperCase()).slice(0,12)+"...)",i.id=l(t.toUpperCase());const e=document.createElement("span");e.innerHTML=o,a.appendChild(i),a.appendChild(e)}const u=document.querySelector("#input"),d=document.querySelectorAll("h1");function S(r){const t=r.target.value.removeAllExceptWords();d.forEach(o=>{o.id.removeAllExceptWords().includes(t)&&o.scrollIntoView()})}u.addEventListener("input",S);
